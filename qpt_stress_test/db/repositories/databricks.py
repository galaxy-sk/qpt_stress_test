...
get_last_before_timestamp = """
SELECT * FROM (
  SELECT asset as currency, 'BINE' as endpoint, 'BINE-1-M-M' AS Account, '' AS BalanceTypee, netAsset as balance, timestamp as asof, ROW_NUMBER() OVER (PARTITION BY asset ORDER BY Timestamp DESC) as rn 
  from qpt.bine_1_m_m_margin_account_asset WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}' 
  UNION
  ...
  from qpt.bine_2_s1_e_account_asset WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}' 
  UNION
  ...
  from qpt.bine_2_s1_f_account_asset WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_2_s1_m_margin_account_asset WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  SELECT asset as currency, 'BINE' as endcopoint, 'BINE-2-S1-P' AS Account, '' AS BalanceType, WalletBalance as balance, timestamp as asof, ROW_NUMBER() OVER (PARTITION BY asset ORDER BY Timestamp DESC) as rn 
  from qpt.bine_2_s1_p_futures_account_assets WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_2_s2_e_account_asset WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_2_s2_f_account_asset WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_2_s2_m_margin_account_asset WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_2_s2_p_futures_account_assets WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_mx_s1_e_account_asset WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_mx_s1_m_margin_account_asset WHERE timestamp < '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_mx_s1_f_account_asset WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bine_mx_s1_p_futures_account_assets WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.btfx_1_m_e_wallet_balance WHERE wallet_type = 'exchange' AND asof_CST <= '{0:%Y-%m-%d %H:%M:%S}' 
  UNION
  ...
  from qpt.bull_1_m_spot_account WHERE asof_CST <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bull_2_m_spot_account WHERE asof_CST <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bull_3_m_spot_account WHERE asof_CST <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.bull_4_m_spot_account WHERE asof_CST <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.crypto_bank_balances WHERE InsertTime <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.crypto_snapshot_balances where Exchange in ('BTSE', 'KRKE', 'LMAC', 'LMAX') AND InsertTime <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.hubi_3_s1_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}' 
  UNION
  ...
  from qpt.hubi_3_s2_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.hubi_3_s3_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.hub2_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION 
  ...
  from qpt.hubi_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}' GROUP BY currency, type, balancetype, asof HAVING type = 'spot' AND balancetype = 'trade' 
  UNION 
  ...
  from qpt.hubi_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}' GROUP BY currency, type, balancetype, asof HAVING type = 'margin' AND balancetype = 'trade' 
  UNION 
  ...
  from qpt.hubi_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}' GROUP BY currency, type, balancetype, asof HAVING type = 'margin' AND balancetype = 'loan' 
  UNION 
  ...
  from qpt.hubi_account_balance WHERE TYPE = 'spot' AND BalanceType = 'trade' AND AsOf <= '{0:%Y-%m-%d %H:%M:%S}' )
  UNION
  ...
  from qpt.hubi_1_m_p_swap_account_info WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.hubi_3_s1_swap_account_info  WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.hubi_3_s1_isolated_margin_loan_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'  
  UNION
  ...
  from qpt.hubi_3_s2_swap_account_info WHERE  AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.hubi_3_s2_isolated_margin_loan_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'  
  UNION
  ...
  from qpt.hubi_3_s3_contract_account_info WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.hubi_3_s3_isolated_margin_loan_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.fubi_contract_account_info WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'  
  UNION
  ...
  from qpt.fub2_contract_account_info WHERE timestamp <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.okex_2_s1_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'  
  UNION
  ...
  from qpt.okex_2_s2_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.okex_2_u1_account_balance WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}'
  UNION
  ...
  from qpt.fireblock_vault_accounts_asset WHERE AsOf <= '{0:%Y-%m-%d %H:%M:%S}' GROUP BY id, asof
  UNION
  ...
  from qpt.woox_1_m_e_holdings WHERE asof_CST <= '{0:%Y-%m-%d %H:%M:%S}'
  ) 
