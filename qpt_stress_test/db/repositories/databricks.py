...
SELECT * FROM (
  ...
  UNION
  SELECT currency as currency, 'HUB2' as endpoint, 'HUB2-M' AS Account, BalanceType, Balance as balance, asof, ROW_NUMBER() OVER (PARTITION BY currency, type, BalanceType ORDER BY AsOf DESC) as rn 
